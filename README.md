...
| Clock Out for Sleep Tracking | User tries to clock out without clocking in            | I am a registered user and not clocked in yet                  | I send a request to clock out                       | I receive an error message that                                            |
...
| Unfollow a User              | User tries to unfollow themselves                      |
